...
fprintf(file, "const uint16_t od_switch_size32_cdf[][3] = {\n");
for k=1:length(p32)
...
fprintf(file, "const uint16_t od_switch_size16_cdf[][8] = {\n");
for k=1:length(p16)
...
fprintf(file, "const uint16_t od_switch_size8_cdf[][16] = {\n");
for k=1:length(p8)
